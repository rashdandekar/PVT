...
exports.GasProperties = exports.Gas = void 0;
class Gas {
...
class GasProperties {
     ...
     */
    calculateZFactor(spgr, h2sPercentage, co2Percentage, pressure, temperature) {
     ...
     */
    calculateGasDensity(spgr, pressure, temperature, zfactor) {
        const tempRankine = temperature + 459.67;
     ...
     */
    calculateGasFormationVolumeFactor(pressure, temperature, zfactor) {
        const tempRankine = temperature + 459.67;
     ...
     */
    calculateGasViscosity(spgr, pressure, temperature, zfactor) {
        const tempRankine = temperature + 459.67;
